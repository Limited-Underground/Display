...
The latest checkpoint kept real state live on the host, but still used host-supplied trust and did not survive restart. This is not durable authenticated on-device operation. See [the live-state physical evidence](tests/hardware/OG-018M-2026-08-09.md).
