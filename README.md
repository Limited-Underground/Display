...
- **Latest software result:** layout reset now preserves typed commit
...
- A host-tested [workflow facade](docs/configuration/GAUGE_LAYOUT_CHANGE_WORKFLOW_V0.md) pairs every operation with that immediate projection under one API. Eight groups pass 100/100 repeats and the complete 47-executable matrix. It owns no lock/task and is not target concurrency evidence.
