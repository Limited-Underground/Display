...
The host supplied trust metadata and reconstructed outbox state after receipt; this is not persistent authenticated on-device operation. See [accepted completion evidence](tests/hardware/OG-018I-2026-08-09.md) and [stale-rejection evidence](tests/hardware/OG-018J-2026-08-09.md).
