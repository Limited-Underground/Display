...
The project is intended to be free/open source and hosted on GitHub, but its license and contribution policy are unresolved. Do not accept external code until governance is recorded.
