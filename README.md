...
The host supplied trust metadata and reconstructed outbox state after receipt; this is not persistent authenticated on-device operation. See [the latest retry-to-accept evidence](tests/hardware/OG-018L-2026-08-09.md).
