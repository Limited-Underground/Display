...
- **Latest software result:** local layout import now accepts only one exact,
...
- **Reset-storage groundwork:** layout reset preserves typed commit
  ...
  prior layout. Eleven adapter groups and twelve core groups pass 100/100
