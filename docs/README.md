...
| Work on a display | [Gauge view model](display/GAUGE_VIEW_MODEL_V0.md), [trend buffer](display/GAUGE_TREND_BUFFER_V0.md), and the [display bring-up plan](../hardware/WAVESHARE_31262_BRINGUP.md) |
