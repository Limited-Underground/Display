...
the OpenTrail repository. External OT-017D evidence also carried 2/2 exact
normative `OGA0` frames and 2/2 correlated `OGK0` responses through two
role-reversed Heltec/SenseCAP cycles with zero loss/duplicates/errors; the host
supplied trust and did not run the OpenGauge pipeline on-device. A passive Classical CAN receiver interface and
...
completed OG-004, OG-005, OG-006, OG-007, OG-008, OG-009, OG-010, OG-010B, OG-010C, OG-010D, OG-010E, OG-011A, OG-012B, OG-012C, OG-013A, OG-014, OG-014A, OG-015, OG-016A, OG-017, OG-018, OG-018A, OG-018B, OG-018C, OG-018D, OG-018E, OG-018F, OG-018G, and external OG-018H evidence are inputs to
