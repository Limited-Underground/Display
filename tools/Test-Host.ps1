...
Invoke-HostTest `
    ...
    -Sources @(
        ...
        (Join-Path $projectRoot 'firmware\components\wireless\src\gauge_telemetry_receiver.cpp'),
        (Join-Path $projectRoot 'firmware\components\wireless\test_support\fake_esp_now_transport.cpp'),
        (Join-Path $projectRoot 'tests\host\gauge_renderer_runtime_tests.cpp')
    )
...
Invoke-HostTest `
    -Name 'gauge_layout_presentation_gate_tests' `
    -Description 'Exact-generation running-layout presentation gate' `
    -IncludeDirectories @(
        (Join-Path $projectRoot 'firmware\components\configuration\include'),
        (Join-Path $projectRoot 'firmware\components\configuration\test_support'),
        (Join-Path $projectRoot 'firmware\components\display\include'),
    ...
    -Sources @(
        ...
        (Join-Path $projectRoot 'firmware\components\wireless\src\gauge_telemetry_receiver.cpp'),
        (Join-Path $projectRoot 'firmware\components\wireless\test_support\fake_esp_now_transport.cpp'),
        (Join-Path $projectRoot 'tests\host\gauge_layout_presentation_gate_tests.cpp')
    )
...
Invoke-HostTest `
    -Name 'gauge_layout_change_coordinator_tests' `
    -Description 'Single-use time-bounded gauge layout confirmation' `
    -IncludeDirectories @(
        (Join-Path $projectRoot 'firmware\components\configuration\include'),
        (Join-Path $projectRoot 'firmware\components\configuration\test_support'),
        (Join-Path $projectRoot 'firmware\components\display\include'),
    ...
    -Sources @(
        ...
        (Join-Path $projectRoot 'firmware\components\wireless\src\telemetry_packet.cpp'),
        (Join-Path $projectRoot 'firmware\components\wireless\src\gauge_telemetry_receiver.cpp'),
        (Join-Path $projectRoot 'tests\host\gauge_layout_change_coordinator_tests.cpp')
    )
...
Invoke-HostTest `
    -Name 'gauge_layout_change_workflow_tests' `
    -Description 'Atomic layout-change operation and operator projection' `
    -IncludeDirectories @(
        (Join-Path $projectRoot 'firmware\components\configuration\include'),
        (Join-Path $projectRoot 'firmware\components\configuration\test_support'),
        (Join-Path $projectRoot 'firmware\components\display\include'),
    ...
    -Sources @(
        ...
        (Join-Path $projectRoot 'firmware\components\wireless\src\telemetry_packet.cpp'),
        (Join-Path $projectRoot 'firmware\components\wireless\src\gauge_telemetry_receiver.cpp'),
        (Join-Path $projectRoot 'tests\host\gauge_layout_change_workflow_tests.cpp')
    )
